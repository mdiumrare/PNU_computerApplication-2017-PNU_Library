	  	...
	  	<div class="container">
		      <form class="form-login" action="<?=$_SERVER['PHP_SELF']?>" method=post>
		        ...
		        <div class="login-wrap">
		            <input type="text" name="user_number" class="form-control" placeholder="User ID" autofocus value="201224466">
		            <br>
		            <input type="password" name="user_password" class="form-control" placeholder="Password" value="1234">
